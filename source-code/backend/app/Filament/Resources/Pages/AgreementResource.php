...
class AgreementResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Filament\Resources\Pages\AgreementResource\Pages\ListAgreements::route('/'),
            'create' => \App\Filament\Resources\Pages\AgreementResource\Pages\CreateAgreement::route('/create'),
            'edit' => \App\Filament\Resources\Pages\AgreementResource\Pages\EditAgreement::route('/{record}/edit'),
        ];
    }
}
