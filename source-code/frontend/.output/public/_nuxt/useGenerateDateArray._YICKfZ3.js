 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Bn=st("UnlockKeyholeIcon",[["circle",{cx:"12",cy:"16",r:"1",key:"1au0dj"}],["rect",{x:"3",y:"10",width:"18",height:"12",rx:"2",key:"6s8ecr"}],["path",{d:"M7 10V7a5 5 0 0 1 9.33-2.5",key:"car5b7"}]]);function _n(e){let m=new Date().getFullYear()-18,B=m-e,b=[];for(var s=m;s>=B;s--)b.push({label:`${s}`,value:`${s}`});return b}export{An as L,In as N,Bn as U,_n as u};
