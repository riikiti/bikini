import{n as C,E as b,B as E,H as N,z as R,I as k,L as w,O as f,aE as H,a5 as L,F as O,P as _,bg as p}from"./entry.PBEUk6LD.js";import{u as j}from"./use-houdini.69uCwGT7.js";const A=e=>{const{heightSmall:r,heightMedium:s,heightLarge:n,borderRadius:t}=e;return{color:"#eee",colorEnd:"#ddd",borderRadius:t,heightSmall:r,heightMedium:s,heightLarge:n}},F={name:"Skeleton",common:C,self:A},I=b([E("skeleton",`
 height: 1em;
 width: 100%;
 transition:
