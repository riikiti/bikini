import{_ as Ke}from"./nuxt-link.Y22xdzxp.js";import{r as C,h as se,b3 as xo,bs as wo,bt as _o,j as Ve,ax as be,bu as So,aB as ge,H as E,L as _,ay as xe,x as V,O as u,E as R,bc as ko,B as $,bv as Po,D as L,C as U,a4 as Co,bn as No,b2 as Ro,n as ke,aL as Re,s as pe,aR as $o,aS as Oo,z as he,v as Y,I as Q,M as Pe,a8 as De,f as Io,aX as We,Q as Mo,P as J,bw as Ue,ar as zo,aH as $e,K as Bo,av as qe,bx as To,by as Eo,aC as Ge,A as oe,bb as Lo,J as ie,aw as Ye,a$ as Xe,q as Ao,bz as Ze,y as ye,aE as Je,aZ as we,be as Fo,F as Me,bA as Ho,bB as jo,bC as Ko,G as Le,o as T,c as j,b as B,w as H,R as x,a as A,t as de,_ as ae,b4 as Vo,V as ue,Y as Qe,bD as me,W as ze,ab as _e,a0 as F,a6 as Do,Z as fe,bE as eo,S as oo,d as Wo,ac as Uo,ai as qo,X as Go}from"./entry.UIkGX9-f.js";import{a as Yo,u as to}from"./index.HMTULmcy.js";import{N as no}from"./Space.y52V3gph.js";import{o as Xo,i as Zo}from"./utils.Wb9bZqhV.js";import{t as Jo}from"./Tag.FnstX0is.js";import{E as Oe}from"./EUserAccoutType.8nCACn_d.js";import{p as ro,N as io,a as Se,V as Qo,f as et,g as ot,r as tt}from"./Popover.T0ZXyHtn.js";import{N as ao,c as ve}from"./createLucideIcon.dL6m1YIl.js";import{C as nt}from"./ChevronRight.MKrWct0W.js";import{h as ce}from"./happens-in.HIJlj3JZ.js";import{u as rt}from"./use-merged-state.LW99PDP2.js";import{g as it,i as at,N as st,c as so,b as lt,m as Ae}from"./utils.XnYCbaKI.js";import{U as dt}from"./user.I5B1a4DD.js";import{_ as Be}from"./_plugin-vue_export-helper.x3n3nnut.js";import{H as ct}from"./heart.M1MSBycF.js";import{M as ut}from"./mail.rKaQJUOi.js";function lo(e){return o=>{o?e.value=o.$el:e.value=null}}function ft(e,o,t){if(!o)return e;const i=C(e.value);let r=null;return se(e,n=>{r!==null&&window.clearTimeout(r),n===!0?t&&!t.value?i.value=!0:r=window.setTimeout(()=>{i.value=!0},o):i.value=!1}),i}function pt(e={},o){const t=xo({ctrl:!1,command:!1,win:!1,shift:!1,tab:!1}),{keydown:i,keyup:r}=e,n=a=>{switch(a.key){case"Control":t.ctrl=!0;break;case"Meta":t.command=!0,t.win=!0;break;case"Shift":t.shift=!0;break;case"Tab":t.tab=!0;break}i!==void 0&&Object.keys(i).forEach(c=>{if(c!==a.key)return;const s=i[c];if(typeof s=="function")s(a);else{const{stop:p=!1,prevent:f=!1}=s;p&&a.stopPropagation(),f&&a.preventDefault(),s.handler(a)}})},l=a=>{switch(a.key){case"Control":t.ctrl=!1;break;case"Meta":t.command=!1,t.win=!1;break;case"Shift":t.shift=!1;break;case"Tab":t.tab=!1;break}r!==void 0&&Object.keys(r).forEach(c=>{if(c!==a.key)return;const s=r[c];if(typeof s=="function")s(a);else{const{stop:p=!1,prevent:f=!1}=s;p&&a.stopPropagation(),f&&a.preventDefault(),s.handler(a)}})},d=()=>{(o===void 0||o.value)&&(ge("keydown",document,n),ge("keyup",document,l)),o!==void 0&&se(o,a=>{a?(ge("keydown",document,n),ge("keyup",document,l)):(be("keydown",document,n),be("keyup",document,l))})};return wo()?(_o(d),Ve(()=>{(o===void 0||o.value)&&(be("keydown",document,n),be("keyup",document,l))})):d(),So(t)}const Fe=E({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const o=C(null),t=C(e.value),i=C(e.value),r=C("up"),n=C(!1),l=_(()=>n.value?`${e.clsPrefix}-base-slot-machine-current-number--${r.value}-scroll`:null),d=_(()=>n.value?`${e.clsPrefix}-base-slot-machine-old-number--${r.value}-scroll`:null);se(V(e,"value"),(s,p)=>{t.value=p,i.value=s,xe(a)});function a(){const s=e.newOriginalNumber,p=e.oldOriginalNumber;p===void 0||s===void 0||(s>p?c("up"):p>s&&c("down"))}function c(s){r.value=s,n.value=!1,xe(()=>{var p;(p=o.value)===null||p===void 0||p.offsetWidth,n.value=!0})}return()=>{const{clsPrefix:s}=e;return u("span",{ref:o,class:`${s}-base-slot-machine-number`},t.value!==null?u("span",{class:[`${s}-base-slot-machine-old-number ${s}-base-slot-machine-old-number--top`,d.value]},t.value):null,u("span",{class:[`${s}-base-slot-machine-current-number`,l.value]},u("span",{ref:"numberWrapper",class:[`${s}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${s}-base-slot-machine-current-number__inner--not-number`]},i.value)),t.value!==null?u("span",{class:[`${s}-base-slot-machine-old-number ${s}-base-slot-machine-old-number--bottom`,d.value]},t.value):null)}}}),{cubicBezierEaseOut:le}=ko;function ht({duration:e=".2s"}={}){return[R("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${le},
 max-width ${e} ${le},
 transform ${e} ${le}
 ...
 width: .6em;
 max-width: .6em;
 `,[ht({duration:".2s"}),Po({duration:".2s",delay:"0s"}),$("base-slot-machine-old-number",`
 display: inline-block;
 opacity: 0;
 position: absolute;
 left: 0;
 right: 0;
 `,[L("top",{transform:"translateY(-100%)"}),L("bottom",{transform:"translateY(100%)"}),L("down-scroll",{animation:"n-base-slot-machine-fade-down-out .2s cubic-bezier(0, 0, .2, 1)",animationIterationCount:1}),L("up-scroll",{animation:"n-base-slot-machine-fade-up-out .2s cubic-bezier(0, 0, .2, 1)",animationIterationCount:1})]),$("base-slot-machine-current-number",`
 display: inline-block;
 position: absolute;
 left: 0;
 top: 0;
...
`,[$o(R("&","--n-merged-color: var(--n-color-modal);")),Oo(R("&","--n-merged-color: var(--n-color-popover);")),R("img",`
 width: 100%;
 height: 100%;
 `),U("text",`
 white-space: nowrap;
 ...
 `,[L("as-is",[$("badge-sup",{position:"static",transform:"translateX(0)"},[$e({transformOrigin:"left bottom",originalTransform:"translateX(0)"})])]),L("dot",[$("badge-sup",`
 height: 8px;
 width: 8px;
 padding: 0;
 min-width: 8px;
...
`,[$e(),$("dropdown-option",`
 ...
 `,[U("prefix, suffix",`
 color: var(--n-option-text-color-hover);
 `),R("&::before","background-color: var(--n-option-color-hover);")]),L("active",`
 color: var(--n-option-text-color-active);
 `,[U("prefix, suffix",`
 color: var(--n-option-text-color-active);
 `),R("&::before","background-color: var(--n-option-color-active);")]),L("child-active",`
