import{n as R,E as b,B as C,H as E,z as N,I as k,L as w,O as f,aE as H,R as L,F as O,P as _,bc as p}from"./entry.Ka6ubjYN.js";import{u as j}from"./use-houdini.ce6Vopfm.js";const A=e=>{const{heightSmall:r,heightMedium:s,heightLarge:n,borderRadius:t}=e;return{color:"#eee",colorEnd:"#ddd",borderRadius:t,heightSmall:r,heightMedium:s,heightLarge:n}},F={name:"Skeleton",common:R,self:A},I=b([C("skeleton",`
 height: 1em;
 width: 100%;
 transition:
