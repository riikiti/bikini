import{_ as yo}from"./nuxt-link.H8RW9rFE.js";import{r as N,h as ie,b2 as xo,br as wo,bs as _o,j as je,ax as be,bt as So,aB as ge,H as A,L as w,ay as xe,x as V,O as u,E as $,be as ko,B as R,bu as Po,D as F,C as U,S as No,aE as Co,b1 as $o,n as Se,bj as Ce,s as pe,aR as Ro,aS as Io,z as he,v as G,I as Q,M as ke,a6 as Ke,f as Oo,aW as Ve,Q as zo,P as J,bv as De,ar as Mo,b5 as $e,K as Bo,av as We,bw as To,bx as Lo,aH as Ue,A as oe,bd as Ao,J as ae,aw as Ye,a_ as qe,q as Fo,by as Ge,y as ye,aJ as Xe,aY as we,bg as Eo,F as Ie,bz as Ho,bA as jo,bB as Ko,G as Le,o as L,c as K,b as z,w as E,U as x,a as T,t as ce,a2 as le,b3 as Vo,Y as ue,$ as Do,bC as me,Z as Ze,a9 as Oe,a4 as j,a0 as Wo,a1 as fe,bD as Je,aa as ze,V as Qe,d as Uo,ab as Yo,_ as qo}from"./entry.5dy0cH0F.js";import{a as Go,u as eo}from"./index.G-9JIfuz.js";import{N as oo}from"./Space.ELVgm9G9.js";import{o as Xo,i as Zo}from"./utils.OeBn0kXO.js";import{t as Jo}from"./Tag.alO4wfiI.js";import{E as Qo}from"./EUserAccoutType.8nCACn_d.js";import{p as to,N as no,j as _e,V as et,f as ot,g as tt,r as nt,u as rt}from"./Popover.iuG8DhXA.js";import{N as ro,c as ve}from"./createLucideIcon.1Vz3pVnp.js";import{C as at}from"./ChevronRight.cTkzwiHn.js";import{h as de}from"./happens-in.HIJlj3JZ.js";import{g as it,i as st,N as lt,c as ao,b as dt,m as Ae}from"./utils.vB_FKgg2.js";import{U as ct}from"./user.2fQOnuQl.js";import{_ as Me}from"./_plugin-vue_export-helper.x3n3nnut.js";import{H as ut}from"./heart.FbAqw4nC.js";import{M as ft}from"./mail.Zl4jUVxX.js";function io(e){return o=>{o?e.value=o.$el:e.value=null}}function pt(e,o,t){if(!o)return e;const a=N(e.value);let r=null;return ie(e,n=>{r!==null&&window.clearTimeout(r),n===!0?t&&!t.value?a.value=!0:r=window.setTimeout(()=>{a.value=!0},o):a.value=!1}),a}function ht(e={},o){const t=xo({ctrl:!1,command:!1,win:!1,shift:!1,tab:!1}),{keydown:a,keyup:r}=e,n=i=>{switch(i.key){case"Control":t.ctrl=!0;break;case"Meta":t.command=!0,t.win=!0;break;case"Shift":t.shift=!0;break;case"Tab":t.tab=!0;break}a!==void 0&&Object.keys(a).forEach(c=>{if(c!==i.key)return;const s=a[c];if(typeof s=="function")s(i);else{const{stop:f=!1,prevent:h=!1}=s;f&&i.stopPropagation(),h&&i.preventDefault(),s.handler(i)}})},l=i=>{switch(i.key){case"Control":t.ctrl=!1;break;case"Meta":t.command=!1,t.win=!1;break;case"Shift":t.shift=!1;break;case"Tab":t.tab=!1;break}r!==void 0&&Object.keys(r).forEach(c=>{if(c!==i.key)return;const s=r[c];if(typeof s=="function")s(i);else{const{stop:f=!1,prevent:h=!1}=s;f&&i.stopPropagation(),h&&i.preventDefault(),s.handler(i)}})},d=()=>{(o===void 0||o.value)&&(ge("keydown",document,n),ge("keyup",document,l)),o!==void 0&&ie(o,i=>{i?(ge("keydown",document,n),ge("keyup",document,l)):(be("keydown",document,n),be("keyup",document,l))})};return wo()?(_o(d),je(()=>{(o===void 0||o.value)&&(be("keydown",document,n),be("keyup",document,l))})):d(),So(t)}const Fe=A({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const o=N(null),t=N(e.value),a=N(e.value),r=N("up"),n=N(!1),l=w(()=>n.value?`${e.clsPrefix}-base-slot-machine-current-number--${r.value}-scroll`:null),d=w(()=>n.value?`${e.clsPrefix}-base-slot-machine-old-number--${r.value}-scroll`:null);ie(V(e,"value"),(s,f)=>{t.value=f,a.value=s,xe(i)});function i(){const s=e.newOriginalNumber,f=e.oldOriginalNumber;f===void 0||s===void 0||(s>f?c("up"):f>s&&c("down"))}function c(s){r.value=s,n.value=!1,xe(()=>{var f;(f=o.value)===null||f===void 0||f.offsetWidth,n.value=!0})}return()=>{const{clsPrefix:s}=e;return u("span",{ref:o,class:`${s}-base-slot-machine-number`},t.value!==null?u("span",{class:[`${s}-base-slot-machine-old-number ${s}-base-slot-machine-old-number--top`,d.value]},t.value):null,u("span",{class:[`${s}-base-slot-machine-current-number`,l.value]},u("span",{ref:"numberWrapper",class:[`${s}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${s}-base-slot-machine-current-number__inner--not-number`]},a.value)),t.value!==null?u("span",{class:[`${s}-base-slot-machine-old-number ${s}-base-slot-machine-old-number--bottom`,d.value]},t.value):null)}}}),{cubicBezierEaseOut:se}=ko;function mt({duration:e=".2s"}={}){return[$("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${se},
 max-width ${e} ${se},
 transform ${e} ${se}
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const on=ve("XIcon",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]),tn={class:"max-w-[200px]"},nn={class:"flex flex-col gap-0.5"},rn={class:"truncate max-w-[100px]"},an={key:0,class:"font-light italic"},sn="https://vimcare.com/assets/empty_user-e28be29d09f6ea715f3916ebebb525103ea068eea8842da42b414206c2523d01.png",ho=A({__name:"UserAvatar",props:{img:{},name:{},email:{default:""},fallbackName:{default:"SC"}},setup(e){return console.log(e.img),(t,a)=>(L(),K("div",tn,[z(x(ue),{quaternary:"",size:"medium"},{default:E(()=>[z(x(oo),{align:"center",wrap:!1},{default:E(()=>[z(x(kt),{src:t.img,"fallback-src":sn,size:"medium",round:""},null,8,["src"]),T("div",nn,[T("div",rn,ce(t.name),1),t.email?(L(),K("div",an,ce(t.email),1)):le("",!0),Vo(t.$slots,"additional")])]),_:3})]),_:3})]))}}),ln={key:0},dn=A({__name:"UserNav",setup(e){const o=Do(),{t}=me(),a=Ze(),{user:r}=Oe(a),n=s=>()=>u(ro,null,{default:()=>u(s)}),l=()=>{a.logout(),o.push(j.MAIN)},d=N([{label:()=>t("header.profile"),key:1,icon:n(ct)},{label:()=>t("header.finance"),key:2,icon:n(en)},{label:()=>t("header.settings"),key:0,icon:n(Qt)},{label:()=>t("header.logout"),key:3,icon:n(Zt)}]),i=w(()=>d.value.reduce((s,f)=>(r.value.role!==Qo.MODEL_ACCOUNT?f.key!==1&&f.key!==2&&s.push(f):s.push(f),s),[])),c=s=>{switch(s){case 0:o.push(j.SETTINGS);break;case 2:o.push(j.FINANCE);break;case 1:o.push(j.PROFILE+`${r.value.id}`);break;case 3:l();break}};return(s,f)=>x(r)?(L(),K("div",ln,[z(x(Xt),{trigger:"click",options:x(i),onSelect:c},{default:E(()=>[z(ho,{img:x(r).avatar,name:x(r).name},null,8,["img","name"])]),_:1},8,["options"])])):le("",!0)}}),cn={},un={width:"20",height:"12",viewBox:"0 0 20 12",xmlns:"http://www.w3.org/2000/svg"},fn=T("path",{d:"M0 1C0 0.447716 0.447715 0 1 0H19C19.5523 0 20 0.447715 20 1V4.2H0V1Z",fill:"white"},null,-1),pn=T("path",{d:"M0 4.2H20V7.8H0V4.2Z",fill:"#0B4EA2"},null,-1),hn=T("path",{d:"M0 7.8H20V11C20 11.5523 19.5523 12 19 12H1C0.447715 12 0 11.5523 0 11V7.8Z",fill:"#EE1C25"},null,-1),mn=[fn,pn,hn];function vn(e,o){return L(),K("svg",un,mn)}const bn=Me(cn,[["render",vn]]),gn={},yn={width:"20",height:"12",viewBox:"0 0 20 12",xmlns:"http://www.w3.org/2000/svg"},xn=Wo('<path d="M0 0V12H20V0H0Z" fill="#012169"></path><path d="M0 0L20 12M20 0L0 12" stroke="white" stroke-width="2"></path><path d="M0 0L20 12M20 0L0 12" stroke="#C8102E" stroke-width="1.33333"></path><path d="M10 0V12M0 6H20" stroke="white" stroke-width="3.33333"></path><path d="M10 0V12M0 6H20" stroke="#C8102E" stroke-width="2"></path>',5),wn=[xn];function _n(e,o){return L(),K("svg",yn,wn)}const Sn=Me(gn,[["render",_n]]),kn={},Pn={width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg"},Nn=T("path",{d:"M0 3.83333C0 3.3731 0.358172 3 0.8 3H15.2C15.6418 3 16 3.3731 16 3.83333V6.5H0V3.83333Z",fill:"#040706"},null,-1),Cn=T("path",{d:"M0 6.5H16V9.5H0V6.5Z",fill:"#C10D32"},null,-1),$n=T("path",{d:"M0 9.5H16V12.1667C16 12.6269 15.6418 13 15.2 13H0.8C0.358172 13 0 12.6269 0 12.1667V9.5Z",fill:"#F9BE40"},null,-1),Rn=[Nn,Cn,$n];function In(e,o){return L(),K("svg",Pn,Rn)}const On=Me(kn,[["render",In]]),zn=A({__name:"SwitcherLocale",setup(e){const{locale:o,setLocale:t}=me(),a=Go(),r=c=>({en:Sn,ru:bn,de:On})[c],n=N(o),l=N([{value:"en"},{value:"ru"},{value:"de"}]),d=c=>{t(c),window.location.href=a(c)},i=c=>u(r(c==null?void 0:c.value));return(c,s)=>(L(),fe(x(Lt),{value:n.value,"onUpdate:value":s[0]||(s[0]=f=>n.value=f),"on-update:value":f=>d(f),options:l.value,size:"medium",trigger:"click","render-label":f=>i(f)},{default:E(()=>[z(x(ue),null,{default:E(()=>[(L(),fe(Je(r(n.value))))]),_:1})]),_:1},8,["value","on-update:value","options","render-label"]))}}),Mn=A({__name:"UserMenu",setup(e){const{t:o}=me(),t=eo(),a=[{href:t(j.WINNER_PAGE),name:o("header.winner")},{href:t(j.USERS),name:o("header.users")}];return(r,n)=>{const l=ze("router-link");return L(),K("nav",null,[z(x(oo),{size:0},{default:E(()=>[(L(),K(Ie,null,Qe(a,(d,i)=>z(l,{key:i,to:d.href},{default:E(()=>[z(x(ue),{size:"small",quaternary:""},{default:E(()=>[Uo(ce(d.name),1)]),_:2},1024)]),_:2},1032,["to"])),64))]),_:1})])}}}),Bn={class:"flex justify-center items-center z-10"},Tn={key:0,class:"fixed right-0 bottom-0 left-0 top-11 bg-white dark:bg-background z-50"},Ln={class:"flex flex-col px-4 py-2 border-b"},An={class:"mt-2"},Fn=["href"],En={class:"px-4 py-2 border-b"},Hn=A({__name:"BurgerMenu",props:{userMenu:{}},setup(e){const o=e;me();const t=Ze(),{user:a}=Oe(t),{userMenu:r}=Yo(o),n=N(!1),l=()=>{n.value=!n.value};return(d,i)=>{const c=ze("n-button");return L(),K("div",Bn,[z(c,{class:"transition-all flex items-center justify-center",onClick:i[0]||(i[0]=s=>l())},{default:E(()=>[(L(),fe(Je(n.value?x(on):x(Jt))))]),_:1}),n.value?(L(),K("div",Tn,[T("div",Ln,[z(ho,{img:x(a).avatar,name:x(a).name,email:x(a).email},null,8,["img","name","email"])]),T("div",An,[(L(!0),K(Ie,null,Qe(x(r),(s,f)=>(L(),K("div",{key:f,class:"px-4 py-2 border-b text-black"},[T("a",{href:s.href,class:"text-black"},ce(s.name),9,Fn)]))),128)),T("div",En,ce(d.$t("header.logout")),1)])])):le("",!0)])}}}),jn={class:"sticky top-0 z-30 shadow-lg bg-white"},Kn={class:"max-w-[1368px] mx-auto px-2 sm:px-4"},Vn={class:"flex justify-between h-10 py-4 sm:h-16 sm:py-0"},Dn={class:"flex gap-2"},Wn={class:"shrink-0 flex items-center"},Un=T("div",{class:"font-extrabold text-slate-600 text-lg md:text-2xl dark:text-white"}," ★ Bikini Star ",-1),Yn={class:"flex items-center"},qn={key:0,class:"ml-3 flex items-center gap-3"},Gn={class:"flex items-center gap-2"},fr=A({__name:"index",setup(e){const{t:o}=me(),t=eo(),a=[{href:t(j.BLOG),name:o("header.blog")},{href:t(j.BOX),name:o("header.box")},{href:t(j.SETTINGS),name:o("header.settings")},{href:t(j.FINANCE),name:o("header.finance")},{href:t(j.PORTFOLIO),name:o("header.portfolio")}],r=qo(),{isMobile:n}=Oe(r);return(l,d)=>{const i=yo,c=ze("router-link");return L(),K("div",jn,[T("div",Kn,[T("div",Vn,[T("div",Dn,[T("div",Wn,[z(i,{to:x(t)(x(j).ACTIVE_CONTEST),class:"no-underline cursor-pointer"},{default:E(()=>[Un]),_:1},8,["to"])]),T("div",Yn,[z(zn)]),x(n)?le("",!0):(L(),K("div",qn,[z(Mn)]))]),T("div",Gn,[z(c,{to:x(t)(x(j).FAVORITES)},{default:E(()=>[z(x(ue),{text:"",size:"medium"},{default:E(()=>[z(x(It),{value:x(r).favouritesCount},{default:E(()=>[z(x(ut))]),_:1},8,["value"])]),_:1})]),_:1},8,["to"]),z(c,{to:x(t)(x(j).MESSENGER)},{default:E(()=>[z(x(ue),{quaternary:"",size:"medium"},{default:E(()=>[z(x(ft))]),_:1})]),_:1},8,["to"]),x(n)?le("",!0):(L(),fe(dn,{key:0,"user-menu":a})),x(n)?(L(),fe(Hn,{key:1,"user-menu":a})):le("",!0)])])])])}}});export{fr as _};
