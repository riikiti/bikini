import{n as R,E as b,B as C,H as N,z as w,I as k,L as E,O as f,aJ as H,R as L,F as O,P as _,aK as p}from"./entry.cMATa27n.js";import{u as j}from"./GradientText.RIrUjOF7.js";const A=e=>{const{heightSmall:r,heightMedium:s,heightLarge:n,borderRadius:t}=e;return{color:"#eee",colorEnd:"#ddd",borderRadius:t,heightSmall:r,heightMedium:s,heightLarge:n}},F={name:"Skeleton",common:R,self:A},I=b([C("skeleton",`
 height: 1em;
 width: 100%;
 transition:
