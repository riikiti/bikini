import{_ as ze}from"./nuxt-link.J_JEgvNs.js";import{r as C,h as se,b3 as wo,bt as _o,bu as So,j as De,ax as be,bv as ko,aB as ge,H as E,L as _,ay as xe,x as V,O as u,E as R,bc as Po,B as $,bw as Co,D as A,C as U,a6 as No,bn as Ro,b2 as $o,n as ke,aL as Re,s as pe,aR as Oo,aS as Io,z as he,v as Y,I as Q,M as Pe,$ as We,f as Mo,aX as Ue,Q as zo,P as J,bx as qe,ar as Bo,aH as $e,K as To,av as Ge,by as Eo,bz as Lo,aC as Ye,A as oe,bb as Ao,J as ie,aw as Xe,a$ as Ze,q as Fo,bA as Je,y as ye,aE as Qe,aZ as we,be as Ho,F as Be,bB as jo,bC as Ko,bD as Vo,G as Fe,o as T,c as j,b as O,w as F,S as g,a as H,t as de,a0 as ae,b4 as Do,T as ue,_ as eo,bE as me,Y as Te,aa as _e,a2 as L,U as Wo,R as fe,bF as oo,V as to,d as Oe,ab as Uo,ai as qo,Z as Go}from"./entry.ydcKSOmp.js";import{a as Yo,u as no}from"./index.2h_-J51O.js";import{N as ro}from"./Space.nPwSXytI.js";import{o as Xo,i as Zo}from"./utils.lhWoHf5m.js";import{t as Jo}from"./Tag.LqWm2sEN.js";import{E as Ie}from"./EUserAccoutType.8nCACn_d.js";import{p as io,N as ao,a as Se,V as Qo,f as et,g as ot,r as tt}from"./Popover.2SHOBVdi.js";import{N as so,c as ve}from"./createLucideIcon.6Cz25YP-.js";import{C as nt}from"./ChevronRight.LWNoaDjQ.js";import{h as ce}from"./happens-in.HIJlj3JZ.js";import{u as rt}from"./use-merged-state._FoYgtTV.js";import{g as it,i as at,N as st,c as lo,b as lt,m as He}from"./utils._lHVxeKi.js";import{U as dt}from"./user.tCfez3hN.js";import{_ as Ee}from"./_plugin-vue_export-helper.x3n3nnut.js";import{H as ct}from"./heart.etCFSy6w.js";import{M as ut}from"./mail.UFdZnLr5.js";function co(e){return o=>{o?e.value=o.$el:e.value=null}}function ft(e,o,t){if(!o)return e;const i=C(e.value);let r=null;return se(e,n=>{r!==null&&window.clearTimeout(r),n===!0?t&&!t.value?i.value=!0:r=window.setTimeout(()=>{i.value=!0},o):i.value=!1}),i}function pt(e={},o){const t=wo({ctrl:!1,command:!1,win:!1,shift:!1,tab:!1}),{keydown:i,keyup:r}=e,n=a=>{switch(a.key){case"Control":t.ctrl=!0;break;case"Meta":t.command=!0,t.win=!0;break;case"Shift":t.shift=!0;break;case"Tab":t.tab=!0;break}i!==void 0&&Object.keys(i).forEach(c=>{if(c!==a.key)return;const s=i[c];if(typeof s=="function")s(a);else{const{stop:f=!1,prevent:p=!1}=s;f&&a.stopPropagation(),p&&a.preventDefault(),s.handler(a)}})},l=a=>{switch(a.key){case"Control":t.ctrl=!1;break;case"Meta":t.command=!1,t.win=!1;break;case"Shift":t.shift=!1;break;case"Tab":t.tab=!1;break}r!==void 0&&Object.keys(r).forEach(c=>{if(c!==a.key)return;const s=r[c];if(typeof s=="function")s(a);else{const{stop:f=!1,prevent:p=!1}=s;f&&a.stopPropagation(),p&&a.preventDefault(),s.handler(a)}})},d=()=>{(o===void 0||o.value)&&(ge("keydown",document,n),ge("keyup",document,l)),o!==void 0&&se(o,a=>{a?(ge("keydown",document,n),ge("keyup",document,l)):(be("keydown",document,n),be("keyup",document,l))})};return _o()?(So(d),De(()=>{(o===void 0||o.value)&&(be("keydown",document,n),be("keyup",document,l))})):d(),ko(t)}const je=E({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const o=C(null),t=C(e.value),i=C(e.value),r=C("up"),n=C(!1),l=_(()=>n.value?`${e.clsPrefix}-base-slot-machine-current-number--${r.value}-scroll`:null),d=_(()=>n.value?`${e.clsPrefix}-base-slot-machine-old-number--${r.value}-scroll`:null);se(V(e,"value"),(s,f)=>{t.value=f,i.value=s,xe(a)});function a(){const s=e.newOriginalNumber,f=e.oldOriginalNumber;f===void 0||s===void 0||(s>f?c("up"):f>s&&c("down"))}function c(s){r.value=s,n.value=!1,xe(()=>{var f;(f=o.value)===null||f===void 0||f.offsetWidth,n.value=!0})}return()=>{const{clsPrefix:s}=e;return u("span",{ref:o,class:`${s}-base-slot-machine-number`},t.value!==null?u("span",{class:[`${s}-base-slot-machine-old-number ${s}-base-slot-machine-old-number--top`,d.value]},t.value):null,u("span",{class:[`${s}-base-slot-machine-current-number`,l.value]},u("span",{ref:"numberWrapper",class:[`${s}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${s}-base-slot-machine-current-number__inner--not-number`]},i.value)),t.value!==null?u("span",{class:[`${s}-base-slot-machine-old-number ${s}-base-slot-machine-old-number--bottom`,d.value]},t.value):null)}}}),{cubicBezierEaseOut:le}=Po;function ht({duration:e=".2s"}={}){return[R("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${le},
 max-width ${e} ${le},
 transform ${e} ${le}
