import{_ as go}from"./nuxt-link.ByvfQKrk.js";import{r as N,h as ie,a_ as yo,bn as xo,bo as wo,j as He,as as be,bp as _o,aw as ge,H as L,L as w,at as xe,x as K,O as u,E as $,ba as So,B as R,bq as ko,D as F,C as U,S as Po,az as No,aZ as Co,n as Se,bf as Ce,s as pe,aN as $o,aO as Ro,z as he,v as Y,I as Q,M as ke,a6 as je,f as Oo,aS as Ke,Q as Io,P as J,br as Ve,am as zo,b1 as $e,K as Mo,aq as De,bs as Bo,bt as To,aD as We,A as oe,b9 as Lo,J as ae,ar as Ue,aW as qe,q as Fo,bu as Ge,y as ye,aF as Ye,aU as we,bc as Ao,F as Oe,bv as Eo,bw as Ho,bx as jo,G as Te,o as T,c as j,b as A,w as W,U as x,a as B,t as ce,a2 as le,a$ as Ko,Y as ue,$ as Vo,by as me,Z as Ze,a9 as Ie,a4 as H,a0 as Do,a1 as fe,bz as Xe,V as Je,d as Wo,aa as Uo,ad as qo,_ as Go}from"./entry.1ZxYl7KD.js";import{a as Yo,u as Qe}from"./index.BIxnQpRe.js";import{N as eo}from"./Space.oLpKv7Xc.js";import{o as Zo,i as Xo}from"./utils.GoHCELvT.js";import{t as Jo}from"./Tag._TRrJXpO.js";import{E as Qo}from"./EUserAccoutType.8nCACn_d.js";import{p as oo,N as to,j as _e,V as et,f as ot,g as tt,r as nt,u as rt}from"./Popover.P0RjMtAw.js";import{N as no,c as ve}from"./createLucideIcon.6peY8C66.js";import{C as at}from"./ChevronRight.ERzNoY86.js";import{h as de}from"./happens-in.HIJlj3JZ.js";import{g as it,i as st,N as lt,c as ro,b as dt,m as Le}from"./utils.hOe-KyoH.js";import{U as ct}from"./user.hNto3Vkt.js";import{_ as ze}from"./_plugin-vue_export-helper.x3n3nnut.js";import{H as ut}from"./heart.gEIE9SMb.js";import{M as ft}from"./mail.LpMNCe8I.js";function ao(e){return o=>{o?e.value=o.$el:e.value=null}}function pt(e,o,t){if(!o)return e;const a=N(e.value);let r=null;return ie(e,n=>{r!==null&&window.clearTimeout(r),n===!0?t&&!t.value?a.value=!0:r=window.setTimeout(()=>{a.value=!0},o):a.value=!1}),a}function ht(e={},o){const t=yo({ctrl:!1,command:!1,win:!1,shift:!1,tab:!1}),{keydown:a,keyup:r}=e,n=i=>{switch(i.key){case"Control":t.ctrl=!0;break;case"Meta":t.command=!0,t.win=!0;break;case"Shift":t.shift=!0;break;case"Tab":t.tab=!0;break}a!==void 0&&Object.keys(a).forEach(c=>{if(c!==i.key)return;const s=a[c];if(typeof s=="function")s(i);else{const{stop:f=!1,prevent:h=!1}=s;f&&i.stopPropagation(),h&&i.preventDefault(),s.handler(i)}})},l=i=>{switch(i.key){case"Control":t.ctrl=!1;break;case"Meta":t.command=!1,t.win=!1;break;case"Shift":t.shift=!1;break;case"Tab":t.tab=!1;break}r!==void 0&&Object.keys(r).forEach(c=>{if(c!==i.key)return;const s=r[c];if(typeof s=="function")s(i);else{const{stop:f=!1,prevent:h=!1}=s;f&&i.stopPropagation(),h&&i.preventDefault(),s.handler(i)}})},d=()=>{(o===void 0||o.value)&&(ge("keydown",document,n),ge("keyup",document,l)),o!==void 0&&ie(o,i=>{i?(ge("keydown",document,n),ge("keyup",document,l)):(be("keydown",document,n),be("keyup",document,l))})};return xo()?(wo(d),He(()=>{(o===void 0||o.value)&&(be("keydown",document,n),be("keyup",document,l))})):d(),_o(t)}const Fe=L({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const o=N(null),t=N(e.value),a=N(e.value),r=N("up"),n=N(!1),l=w(()=>n.value?`${e.clsPrefix}-base-slot-machine-current-number--${r.value}-scroll`:null),d=w(()=>n.value?`${e.clsPrefix}-base-slot-machine-old-number--${r.value}-scroll`:null);ie(K(e,"value"),(s,f)=>{t.value=f,a.value=s,xe(i)});function i(){const s=e.newOriginalNumber,f=e.oldOriginalNumber;f===void 0||s===void 0||(s>f?c("up"):f>s&&c("down"))}function c(s){r.value=s,n.value=!1,xe(()=>{var f;(f=o.value)===null||f===void 0||f.offsetWidth,n.value=!0})}return()=>{const{clsPrefix:s}=e;return u("span",{ref:o,class:`${s}-base-slot-machine-number`},t.value!==null?u("span",{class:[`${s}-base-slot-machine-old-number ${s}-base-slot-machine-old-number--top`,d.value]},t.value):null,u("span",{class:[`${s}-base-slot-machine-current-number`,l.value]},u("span",{ref:"numberWrapper",class:[`${s}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${s}-base-slot-machine-current-number__inner--not-number`]},a.value)),t.value!==null?u("span",{class:[`${s}-base-slot-machine-old-number ${s}-base-slot-machine-old-number--bottom`,d.value]},t.value):null)}}}),{cubicBezierEaseOut:se}=So;function mt({duration:e=".2s"}={}){return[$("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${se},
 max-width ${e} ${se},
 transform ${e} ${se}
 ...
 left: 0;
 right: 0;
 `,[F("top",{transform:"translateY(-100%)"}),F("bottom",{transform:"translateY(100%)"}),F("down-scroll",{animation:"n-base-slot-machine-fade-down-out .2s cubic-bezier(0, 0, .2, 1)",animationIterationCount:1}),F("up-scroll",{animation:"n-base-slot-machine-fade-up-out .2s cubic-bezier(0, 0, .2, 1)",animationIterationCount:1})]),R("base-slot-machine-current-number",`
 display: inline-block;
 position: absolute;
 left: 0;
 top: 0;
 ...
 transform: translateY(0);
 width: .6em;
 `,[F("down-scroll",{animation:"n-base-slot-machine-fade-down-in .2s cubic-bezier(0, 0, .2, 1)",animationIterationCount:1}),F("up-scroll",{animation:"n-base-slot-machine-fade-up-in .2s cubic-bezier(0, 0, .2, 1)",animationIterationCount:1}),U("inner",`
 display: inline-block;
 position: absolute;
 right: 0;
 top: 0;
...
`,[$o($("&","--n-merged-color: var(--n-color-modal);")),Ro($("&","--n-merged-color: var(--n-color-popover);")),$("img",`
 ...
 `),U("text","line-height: 1.25")]),St=Object.assign(Object.assign({},Q.props),{size:[String,Number],src:String,circle:{type:Boolean,default:void 0},objectFit:String,round:{type:Boolean,default:void 0},bordered:{type:Boolean,default:void 0},onError:Function,fallbackSrc:String,intersectionObserverOptions:Object,lazy:Boolean,onLoad:Function,renderPlaceholder:Function,renderFallback:Function,imgProps:Object,color:String}),kt=L({name:"Avatar",props:St,setup(e){const{mergedClsPrefixRef:o,inlineThemeDisabled:t}=he(e),a=N(!1);let r=null;const n=N(null),l=N(null),d=()=>{const{value:p}=n;if(p&&(r===null||r!==p.innerHTML)){r=p.innerHTML;const{value:S}=l;if(S){const{offsetWidth:O,offsetHeight:V}=S,{offsetWidth:E,offsetHeight:te}=p,Z=.9,q=Math.min(O/E*Z,V/te*Z,1);p.style.transform=`translateX(-50%) translateY(-50%) scale(${q})`}}},i=Y(wt,null),c=w(()=>{const{size:p}=e;if(p)return p;const{size:S}=i||{};return S||"medium"}),s=Q("Avatar","-avatar",_t,xt,e,o),f=Y(Jo,null),h=w(()=>{if(i)return!0;const{round:p,circle:S}=e;return p!==void 0||S!==void 0?p||S:f?f.roundRef.value:!1}),_=w(()=>i?!0:e.bordered||!1),b=w(()=>{const p=c.value,S=h.value,O=_.value,{color:V}=e,{self:{borderRadius:E,fontSize:te,color:Z,border:q,colorModal:ee,colorPopover:G},common:{cubicBezierEaseInOut:v}}=s.value;let C;return typeof p=="number"?C=`${p}px`:C=s.value.self[J("height",p)],{"--n-font-size":te,"--n-border":O?q:"none","--n-border-radius":S?"50%":E,"--n-color":V||Z,"--n-color-modal":V||ee,"--n-color-popover":V||G,"--n-bezier":v,"--n-merged-size":`var(--n-avatar-size-override, ${C})`}}),g=t?ke("avatar",w(()=>{const p=c.value,S=h.value,O=_.value,{color:V}=e;let E="";return p&&(typeof p=="number"?E+=`a${p}`:E+=p[0]),S&&(E+="b"),O&&(E+="c"),V&&(E+=Ve(V)),E}),b,e):void 0,m=N(!e.lazy);je(()=>{if(e.lazy&&e.intersectionObserverOptions){let p;const S=Oo(()=>{p==null||p(),p=void 0,e.lazy&&(p=Zo(l.value,e.intersectionObserverOptions,m))});He(()=>{S(),p==null||p()})}}),ie(()=>{var p;return e.src||((p=e.imgProps)===null||p===void 0?void 0:p.src)},()=>{a.value=!1});const z=N(!e.lazy);return{textRef:n,selfRef:l,mergedRoundRef:h,mergedClsPrefix:o,fitTextTransform:d,cssVars:t?void 0:b,themeClass:g==null?void 0:g.themeClass,onRender:g==null?void 0:g.onRender,hasLoadError:a,shouldStartLoading:m,loaded:z,mergedOnError:p=>{if(!m.value)return;a.value=!0;const{onError:S,imgProps:{onError:O}={}}=e;S==null||S(p),O==null||O(p)},mergedOnLoad:p=>{const{onLoad:S,imgProps:{onLoad:O}={}}=e;S==null||S(p),O==null||O(p),z.value=!0}}},render(){var e,o;const{$slots:t,src:a,mergedClsPrefix:r,lazy:n,onRender:l,loaded:d,hasLoadError:i,imgProps:c={}}=this;l==null||l();let s;const f=!d&&!i&&(this.renderPlaceholder?this.renderPlaceholder():(o=(e=this.$slots).placeholder)===null||o===void 0?void 0:o.call(e));return this.hasLoadError?s=this.renderFallback?this.renderFallback():Ke(t.fallback,()=>[u("img",{src:this.fallbackSrc,style:{objectFit:this.objectFit}})]):s=Io(t.default,h=>{if(h)return u(zo,{onResize:this.fitTextTransform},{default:()=>u("span",{ref:"textRef",class:`${r}-avatar__text`},h)});if(a||c.src){const _=this.src||c.src;return u("img",Object.assign(Object.assign({},c),{loading:Xo&&!this.intersectionObserverOptions&&n?"lazy":"eager",src:n&&this.intersectionObserverOptions?this.shouldStartLoading?_:void 0:_,"data-image-src":_,onLoad:this.mergedOnLoad,onError:this.mergedOnError,style:[c.style||"",{objectFit:this.objectFit},f?{height:"0",width:"0",visibility:"hidden",position:"absolute"}:""]}))}}),u("span",{ref:"selfRef",class:[`${r}-avatar`,this.themeClass],style:this.cssVars},s,n&&f)}}),Pt=e=>{const{errorColor:o,infoColor:t,successColor:a,warningColor:r,fontFamily:n}=e;return{color:o,colorInfo:t,colorSuccess:a,colorError:o,colorWarning:r,fontSize:"12px",fontFamily:n}},Nt={name:"Badge",common:Se,self:Pt},Ct=Nt,$t=$([$("@keyframes badge-wave-spread",{from:{boxShadow:"0 0 0.5px 0px var(--n-ripple-color)",opacity:.6},to:{boxShadow:"0 0 0.5px 4.5px var(--n-ripple-color)",opacity:0}}),R("badge",`
 display: inline-flex;
 position: relative;
 vertical-align: middle;
 font-family: var(--n-font-family);
 `,[F("as-is",[R("badge-sup",{position:"static",transform:"translateX(0)"},[$e({transformOrigin:"left bottom",originalTransform:"translateX(0)"})])]),F("dot",[R("badge-sup",`
 height: 8px;
 width: 8px;
 padding: 0;
 min-width: 8px;
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const on=ve("XIcon",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]),tn={class:"max-w-[200px]"},nn={class:"flex flex-col gap-0.5"},rn={class:"truncate max-w-[100px]"},an={key:0,class:"font-light italic"},sn="https://vimcare.com/assets/empty_user-e28be29d09f6ea715f3916ebebb525103ea068eea8842da42b414206c2523d01.png",po=L({__name:"UserAvatar",props:{img:{},name:{},email:{default:""},fallbackName:{default:"SC"}},setup(e){return console.log(e.img),(t,a)=>(T(),j("div",tn,[A(x(ue),{quaternary:"",size:"medium"},{default:W(()=>[A(x(eo),{align:"center",wrap:!1},{default:W(()=>[A(x(kt),{src:t.img,"fallback-src":sn,size:"medium",round:""},null,8,["src"]),B("div",nn,[B("div",rn,ce(t.name),1),t.email?(T(),j("div",an,ce(t.email),1)):le("",!0),Ko(t.$slots,"additional")])]),_:3})]),_:3})]))}}),ln={key:0},dn=L({__name:"UserNav",setup(e){const o=Vo(),{t}=me(),a=Ze(),{user:r}=Ie(a),n=s=>()=>u(no,null,{default:()=>u(s)}),l=()=>{a.logout(),o.push(H.MAIN)},d=N([{label:()=>t("header.profile"),key:1,icon:n(ct)},{label:()=>t("header.finance"),key:2,icon:n(en)},{label:()=>t("header.settings"),key:0,icon:n(Qt)},{label:()=>t("header.logout"),key:3,icon:n(Xt)}]),i=w(()=>d.value.reduce((s,f)=>(r.value.role!==Qo.MODEL_ACCOUNT?f.key!==1&&f.key!==2&&s.push(f):s.push(f),s),[])),c=s=>{switch(s){case 0:o.push(H.SETTINGS);break;case 2:o.push(H.FINANCE);break;case 1:o.push(H.PROFILE+`${r.value.id}`);break;case 3:l();break}};return(s,f)=>x(r)?(T(),j("div",ln,[A(x(Zt),{trigger:"click",options:x(i),onSelect:c},{default:W(()=>[A(po,{img:x(r).avatar,name:x(r).name},null,8,["img","name"])]),_:1},8,["options"])])):le("",!0)}}),cn={},un={width:"20",height:"12",viewBox:"0 0 20 12",xmlns:"http://www.w3.org/2000/svg"},fn=B("path",{d:"M0 1C0 0.447716 0.447715 0 1 0H19C19.5523 0 20 0.447715 20 1V4.2H0V1Z",fill:"white"},null,-1),pn=B("path",{d:"M0 4.2H20V7.8H0V4.2Z",fill:"#0B4EA2"},null,-1),hn=B("path",{d:"M0 7.8H20V11C20 11.5523 19.5523 12 19 12H1C0.447715 12 0 11.5523 0 11V7.8Z",fill:"#EE1C25"},null,-1),mn=[fn,pn,hn];function vn(e,o){return T(),j("svg",un,mn)}const bn=ze(cn,[["render",vn]]),gn={},yn={width:"20",height:"12",viewBox:"0 0 20 12",xmlns:"http://www.w3.org/2000/svg"},xn=Do('<path d="M0 0V12H20V0H0Z" fill="#012169"></path><path d="M0 0L20 12M20 0L0 12" stroke="white" stroke-width="2"></path><path d="M0 0L20 12M20 0L0 12" stroke="#C8102E" stroke-width="1.33333"></path><path d="M10 0V12M0 6H20" stroke="white" stroke-width="3.33333"></path><path d="M10 0V12M0 6H20" stroke="#C8102E" stroke-width="2"></path>',5),wn=[xn];function _n(e,o){return T(),j("svg",yn,wn)}const Sn=ze(gn,[["render",_n]]),kn={},Pn={width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg"},Nn=B("path",{d:"M0 3.83333C0 3.3731 0.358172 3 0.8 3H15.2C15.6418 3 16 3.3731 16 3.83333V6.5H0V3.83333Z",fill:"#040706"},null,-1),Cn=B("path",{d:"M0 6.5H16V9.5H0V6.5Z",fill:"#C10D32"},null,-1),$n=B("path",{d:"M0 9.5H16V12.1667C16 12.6269 15.6418 13 15.2 13H0.8C0.358172 13 0 12.6269 0 12.1667V9.5Z",fill:"#F9BE40"},null,-1),Rn=[Nn,Cn,$n];function On(e,o){return T(),j("svg",Pn,Rn)}const In=ze(kn,[["render",On]]),zn=L({__name:"SwitcherLocale",setup(e){const{locale:o,setLocale:t}=me(),a=Yo(),r=c=>({en:Sn,ru:bn,de:In})[c],n=N(o),l=N([{value:"en"},{value:"ru"},{value:"de"}]),d=c=>{t(c),window.location.href=a(c)},i=c=>u(r(c==null?void 0:c.value));return(c,s)=>(T(),fe(x(Lt),{value:n.value,"onUpdate:value":s[0]||(s[0]=f=>n.value=f),"on-update:value":f=>d(f),options:l.value,size:"medium",trigger:"click","render-label":f=>i(f)},{default:W(()=>[A(x(ue),null,{default:W(()=>[(T(),fe(Xe(r(n.value))))]),_:1})]),_:1},8,["value","on-update:value","options","render-label"]))}}),Mn=L({__name:"UserMenu",setup(e){const{t:o}=me(),t=Qe(),a=[{href:t(H.WINNER_PAGE),name:o("header.winner")},{href:t(H.USERS),name:o("header.users")}];return(r,n)=>(T(),j("nav",null,[A(x(eo),{size:0},{default:W(()=>[(T(),j(Oe,null,Je(a,(l,d)=>A(x(ue),{key:d,size:"small",quaternary:"",tag:"a",href:l.href},{default:W(()=>[Wo(ce(l.name),1)]),_:2},1032,["href"])),64))]),_:1})]))}}),Bn={class:"flex justify-center items-center z-10"},Tn={key:0,class:"fixed right-0 bottom-0 left-0 top-11 bg-white dark:bg-background z-50"},Ln={class:"flex flex-col px-4 py-2 border-b"},Fn={class:"mt-2"},An=["href"],En={class:"px-4 py-2 border-b"},Hn=L({__name:"BurgerMenu",props:{userMenu:{}},setup(e){const o=e;me();const t=Ze(),{user:a}=Ie(t),{userMenu:r}=Uo(o),n=N(!1),l=()=>{n.value=!n.value};return(d,i)=>{const c=qo("n-button");return T(),j("div",Bn,[A(c,{class:"transition-all flex items-center justify-center",onClick:i[0]||(i[0]=s=>l())},{default:W(()=>[(T(),fe(Xe(n.value?x(on):x(Jt))))]),_:1}),n.value?(T(),j("div",Tn,[B("div",Ln,[A(po,{img:x(a).avatar,name:x(a).name,email:x(a).email},null,8,["img","name","email"])]),B("div",Fn,[(T(!0),j(Oe,null,Je(x(r),(s,f)=>(T(),j("div",{key:f,class:"px-4 py-2 border-b text-black"},[B("a",{href:s.href,class:"text-black"},ce(s.name),9,An)]))),128)),B("div",En,ce(d.$t("header.logout")),1)])])):le("",!0)])}}}),jn={class:"sticky top-0 z-30 shadow-lg bg-white"},Kn={class:"max-w-[1368px] mx-auto px-2 sm:px-4"},Vn={class:"flex justify-between h-10 py-4 sm:h-16 sm:py-0"},Dn={class:"flex gap-2"},Wn={class:"shrink-0 flex items-center"},Un=B("div",{class:"font-extrabold text-slate-600 text-lg md:text-2xl dark:text-white"}," ★ Bikini Star ",-1),qn={class:"flex items-center"},Gn={key:0,class:"ml-3 flex items-center gap-3"},Yn={class:"flex items-center gap-2"},fr=L({__name:"index",setup(e){const{t:o}=me(),t=Qe(),a=[{href:t(H.BLOG),name:o("header.blog")},{href:t(H.BOX),name:o("header.box")},{href:t(H.SETTINGS),name:o("header.settings")},{href:t(H.FINANCE),name:o("header.finance")},{href:t(H.PORTFOLIO),name:o("header.portfolio")}],r=Go(),{isMobile:n}=Ie(r);return(l,d)=>{const i=go;return T(),j("div",jn,[B("div",Kn,[B("div",Vn,[B("div",Dn,[B("div",Wn,[A(i,{to:x(t)(x(H).ACTIVE_CONTEST),class:"no-underline cursor-pointer"},{default:W(()=>[Un]),_:1},8,["to"])]),B("div",qn,[A(zn)]),x(n)?le("",!0):(T(),j("div",Gn,[A(Mn)]))]),B("div",Yn,[A(x(ue),{text:"",tag:"a",href:x(t)(x(H).FAVORITES),size:"medium"},{default:W(()=>[A(x(Ot),{value:x(r).favouritesCount},{default:W(()=>[A(x(ut))]),_:1},8,["value"])]),_:1},8,["href"]),A(x(ue),{quaternary:"",tag:"a",href:x(t)(x(H).MESSENGER),size:"medium"},{default:W(()=>[A(x(ft))]),_:1},8,["href"]),x(n)?le("",!0):(T(),fe(dn,{key:0,"user-menu":a})),x(n)?(T(),fe(Hn,{key:1,"user-menu":a})):le("",!0)])])])])}}});export{fr as _};
